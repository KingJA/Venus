...
public class ProgressWheel extends View {
    ...
    /**
     * Set the properties of the paints we're using to OK
    ...
    /**
     * Set the bounds of the component OK
     */
    ...
    /**
     * Parse the attributes passed to the view from the XML OK
     *
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            float deltaNormalized = deltaTime * spinSpeed / 1000.0f;//计算deltaTime这段时间经过的角度
